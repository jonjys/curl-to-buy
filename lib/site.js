// Canonical public host. Vercel Production must set NEXT_PUBLIC_SITE_URL to the same value
// and attach getpaidlink.nyttolabs.com. pay.nyttolabs.com 308-redirects here (next.config.mjs).
export const SITE = process.env.NEXT_PUBLIC_SITE_URL || 'https://getpaidlink.nyttolabs.com'
