...
const FROM = process.env.RECOVER_EMAIL_FROM || 'Curl-to-Buy <onboarding@resend.dev>'
...
export async function sendVerificationCode(email, code) {
  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: FROM,
      to: email,
      subject: `${code} is your Curl-to-Buy code`,
      text: `Your Curl-to-Buy verification code is ${code}. It expires in 10 minutes.\n\nIf you did not request this, ignore this email — your account is unaffected.`,
    }),
  })
