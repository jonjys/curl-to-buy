  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-xs leading-relaxed text-muted">{connect.subscribed
        ? (sv ? 'Med abonnemang: minst 50 kr. GetPaidLink tar ingen procent på försäljningen. Stripe drar sin kortavgift från beloppet. Köparen anger leveransadressen i Stripe Checkout.' : 'With a subscription: 50 SEK minimum. GetPaidLink takes no percentage of the sale. Stripe deducts its card fee from the amount. The buyer enters the shipping address in Stripe Checkout.')
        : (sv ? 'Utan abonnemang: minst 100 kr. GetPaidLink tar 5%. Stripe drar också sin kortavgift. Köparen anger leveransadressen i Stripe Checkout.' : 'Without a subscription: 100 SEK minimum. GetPaidLink takes 5%. Stripe also deducts its card fee. The buyer enters the shipping address in Stripe Checkout.')}</p>
