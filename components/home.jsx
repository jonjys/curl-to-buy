      ...
      <main>
        <section className="mx-auto grid max-w-5xl items-center gap-8 px-4 pb-6 pt-8 sm:px-6 sm:pt-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-sm text-muted">{sv ? 'Säljare ansluter Stripe en gång. Köpare behöver inget konto.' : 'Sellers connect Stripe once. Buyers need no account.'}</p>
          ...
          <figure className="nl-card nl-card-glow relative overflow-hidden rounded-2xl">
            ...
            <figcaption className="relative border-t border-white/5 bg-paper/40 p-5 sm:p-7">
              ...
              <p className="mt-0.5 text-sm text-muted">{t.sampleKeep} {formatUsd(keepUsd(DEFAULT_USD))} {sv ? 'före Stripe- och andra avgifter' : 'before Stripe and other fees'}</p>
            </figcaption>
          </figure>
        </section>
