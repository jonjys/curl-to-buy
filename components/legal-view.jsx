...
const DOCS = {
  terms: {
    en: { title: 'Terms', lead: 'Curl-to-Buy is a Nytto Labs service for selling physical products and digital files.', sections: [
      ...
      ['Fees', 'Without a paid subscription, new links have a $10 USD minimum (100 SEK for physical items) and Curl-to-Buy takes 5% of the item price as an application fee. With an active Start, Grow or Scale subscription, the minimum is $5 USD (50 SEK for physical items) and Curl-to-Buy takes no percentage of the sale. Stripe deducts its card fee from the seller either way. Existing links remain purchasable; new links use the rules in force at creation and checkout. Subscription prices and link allowances are shown before payment; subscriptions renew monthly until canceled.'],
