...
const DOCS = {
  terms: {
    en: { title: 'Terms', lead: 'GetPaidLink is a Nytto Labs service for selling physical products and digital files.', sections: [
      ...
      ['Fees', 'Without a paid subscription, new links have a $10 USD minimum (100 SEK for physical items) and GetPaidLink takes 5% of the item price as an application fee. With an active Start, Grow or Scale subscription, the minimum is $5 USD (50 SEK for physical items) and GetPaidLink takes no percentage of the sale. Stripe deducts its card fee from the seller either way. Existing links remain purchasable; new links use the rules in force at creation and checkout. Subscription prices and link allowances are shown before payment; subscriptions renew monthly until canceled.'],
      ...
      ['Subscriptions', 'A paid subscription is optional. It lowers the minimum price and removes the 5% platform fee, and it includes a monthly allowance of new links. Link allowances renew each billing period. Cancel through subscription management; access continues through the paid period. If payment fails or the subscription ends, new links use the free $10 / 5% terms; existing paid purchases stay available to buyers.'],
      ['Contact', `Questions: ${SUPPORT}.`],
    ] },
    sv: { title: 'Villkor', lead: 'GetPaidLink är en Nytto Labs-tjänst för försäljning av fysiska produkter och digitala filer.', sections: [
      ...
      ['Avgifter', 'Utan betalt abonnemang är minsta priset $10 (100 kr för fysiska varor) och GetPaidLink tar 5% av varans pris som plattformsavgift. Med aktivt Start-, Grow- eller Scale-abonnemang är minsta priset $5 (50 kr för fysiska varor) och GetPaidLink tar ingen procent på försäljningen. Stripe drar sin kortavgift från säljaren i båda fallen. Befintliga länkar går fortfarande att köpa; nya länkar följer reglerna vid skapande och kassa. Pris och länkgräns visas före betalning. Abonnemang förnyas varje månad tills det sägs upp.'],
      ...
      ['Abonnemang', 'Ett betalt abonnemang är valfritt. Det sänker minsta priset och tar bort plattformens 5%, och ger ett månadsantal nya länkar. Länkgränsen förnyas varje betalperiod. Avsluta i abonnemangshanteringen; åtkomsten gäller till den betalda periodens slut. Vid misslyckad betalning eller avslutat abonnemang skapas nya länkar enligt gratisvillkoren ($10 / 5%). Redan betalda köp är fortsatt tillgängliga för köparen.'],
